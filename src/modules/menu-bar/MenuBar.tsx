  ...
  return (
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="w-full max-w-[1800px] mx-auto px-6 lg:px-12 flex h-16 items-center">
          ...
          <Menubar className="ml-auto rounded-full border border-border bg-muted/30 backdrop-blur-sm shadow-sm px-4 py-1">
            {/* Página Principal */}
            <MenubarMenu>
              <MenubarTrigger
            ...
            <div className="ml-4 flex items-center gap-2">
              <Dialog open={loginDialogOpen} onOpenChange={setLoginDialogOpen}>
                <DialogTrigger asChild>
                  <Button
                    variant="outline"
                    className="border-primary text-primary hover:bg-primary/10 hover:text-primary-foreground transition-colors"
                  >
                    Iniciar Sesión
                  </Button>
                </DialogTrigger>
              ...
              >
                <DialogTrigger asChild>
                  <Button className="bg-primary text-primary-foreground hover:brightness-110 transition duration-200">
                    Crear Cuenta
                  </Button>
                </DialogTrigger>
                <DialogContent className="sm:max-w-[425px]">
      ...
      <div className="fixed bottom-6 right-6 z-50">
        {isChatOpen ? (
          ...
          <Button
            ...
            variant="outline"
            className="bg-accent text-accent-foreground hover:bg-accent/80 rounded-full w-16 h-16 shadow-xl flex items-center justify-center"
          >
